<template>
  <a-card :bordered="false" v-action:get_list>
        ...
        <a-row :gutter="48">
          <a-col :md="8" :sm="24">
            <a-form-item label="CGI UID">
              <a-input v-model="filterParams.uid" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="HTTP UID">
              <a-input v-model="filterParams.http_uid" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :md="8" :sm="24">
            <a-form-item label="url">
              <a-input v-model="filterParams.url" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="method">
              <a-input v-model="filterParams.method" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <a-form-item label="code">
              <a-input v-model="filterParams.code" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
    ...
    >
      <pre slot="expandedRowRender" slot-scope="record" style="margin: 0">{{
        record.info
      }}</pre>
    ...
    >
      <a-form :form="infoForm">
        ...
        >
          <a-input
            placeholder="http uid"
            v-model="infoParams.http_uid"
            id="cgi_http_uid"
          />
        </a-form-item>
