    ...
    <s-table
      ...
      <span slot="action" slot-scope="record">
        ...
        <a
          v-show="record.status !== 1"
          v-action:activate
          @click="handleActivateHttp(record)"
...
import { activateHttp, getHttpList, removeHttp, saveHttpInfo, updateHttpInfo } from '@/api/manager/asset/outside/http'
