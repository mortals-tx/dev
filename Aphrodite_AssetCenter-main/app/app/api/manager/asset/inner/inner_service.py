...
from app.models.asset import InnerService, Zone
from app.libs.success_types import Success


innerservice = Redprint('innerservice')


@innerservice.route('', methods=['GET'])
@auth.login_required
def get_list():
    ...
    pagination = InnerService.list_items_paginate_by_search(page=page_no, per_page=page_size, uid=uid,
